  ...
  return (
    <div className="flex">
      ...
      <div className="flex flex-col flex-1">
        ...
        >
          <h1 className="text-5xl text-center font-bold mb-8">Business</h1>
        </div>
        <div className="p-8 flex-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-10">
            ...
            <CourseCard
              title="Excel: Boosting Efficiency and Collaboration"
              image={excelefficiency}
            />
            <CourseCard title="Excel Copilot" image={leadershipscrum} />
            <CourseCard
              title="Applying Leadership as a Scrum Master"
              image={excelcopilot}
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <CourseCard
              title="Mistakes to Avoid When Managing"
              image={mistakesavoid}
            />
            <CourseCard
              title="Your Time / Using Feedback to Drive"
              image={yourtime}
            />
            <CourseCard
              title="Generative AI for Business Analysis"
              image={aiforbusiness}
            />
            <CourseCard
              title="Generative AI for Improving Writing"
              image={aiforwriting}
            />
          </div>
          <br></br>
          <h2 className="text-2xl font-semibold mb-4">
            New Product and UX Courses
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <CourseCard
              title="Product Design: Design Patterns"
              image={designpatterns}
            />
            <CourseCard
              title="Product Design: User Research and Analysis"
              image={userresearch}
            />
            <CourseCard
              title="Product Management: Building Roadmaps"
              image={buildingroadmaps}
            />
            <CourseCard
              title="Product Design Fundamentals"
              image={productdesignfundamentals}
            />
          </div>
          <br></br>
          <h2 className="text-2xl font-semibold mb-4">
          ...
          <p>
            Explore the most popular Business topics in use by professionals
            today
          </p>
          <br></br>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          ...
          <p>
            Looking to get certified? Start here to prepare for the most
            in-demand Business certifications
          </p>
          <br></br>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <CourseCard
              title="Project Management Institute"
              image={projectmanagmentinst}
            />

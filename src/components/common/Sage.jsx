    ...
    <section className="mt-8">
      ...
      <div>
        ...
        <ul className="list-disc ml-6">
          ...
          <li>
            <h3 className="text-xl font-semibold">Introduction to Python for IT Pros and Sysadmins</h3>
            <p>
          ...
          <li>
            <h3 className="text-xl font-semibold">Playwright Foundations with Python</h3>
            <p>
          ...
          <li>
            <h3 className="text-xl font-semibold">Python for Linux System Administration</h3>
            <p>
          ...
          <li>
            <h3 className="text-xl font-semibold">Migrating Python 2 to Python 3</h3>
            <p>
          ...
          <li>
            <h3 className="text-xl font-semibold">Design Patterns in Python 3</h3>
            <p>
    ...
    <div className="fixed bottom-6 right-8 flex flex-col gap-2 items-end">
      ...
      >
        <div className="h-[80%] overflow-scroll p-10" ref={textChatRef}>
          <section>
            ...
            <main className="text-justify mt-2">
              <p>
                Hi! I’m Sage. Here are a few things I can do to help you make
                the most out of NexusHive:
              </p>
              <ul className="list-disc ml-6">
                <li>
              ...
              <ul className="list-disc ml-6">
                <li>
                  ...
                  information, as your chat history might be reviewed or
                  utilized to enhance our services.
                </li>
                <li>
        ...
        <section className="h-[10%] text-justify leading-4 text-xs p-4">
          <p>
            Do not disclose sensitive personal data; chat logs may be utilized
            for product enhancements. AI recommendations may be inaccurate,
            verify independently. By continuing you agree to{" "}

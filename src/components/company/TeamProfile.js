...
const teamMembers = [
  ...
  {
    name: "Medhat Elsayed",
    title: "EXECUTIVE DIRECTOR • CONSULTANT • MENA REGION",
  ...
  {
    name: "Nathan Maart",
    title: "EXECUTIVE DIRECTOR • CONSULTANT • GLOBAL",
...
const TeamProfilePage = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-20 text-center mb-40">
      <p className="uppercase text-sm tracking-widest text-gray-500 mb-2">
        Meet
      </p>
      <h1 className="text-6xl font-semibold text-gray-800 mb-20">The Team</h1>

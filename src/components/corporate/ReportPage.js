  ...
  return [
    {
      ...
      registrationDate: "2025-04-01T10:00:00",
      lastLogin: "2025-04-28T14:30:00",
      status: "active",
    },
    {
      id: 2,
      ...
      registrationDate: "2025-04-02T11:15:00",
    ...
    },
    {
      ...
      registrationDate: "2025-04-03T12:30:00",
      lastLogin: "2025-04-27T16:45:00",
      status: "active",
    },
    {
      id: 4,
      ...
      registrationDate: "2025-04-04T14:45:00",
      lastLogin: "2025-04-25T11:20:00",
      status: "inactive",
    },
    {
      id: 5,
      ...
      registrationDate: "2025-04-05T08:30:00",
      lastLogin: "2025-04-30T10:10:00",
      status: "active",
    },
    {
      id: 6,
      ...
      registrationDate: "2025-04-06T13:20:00",
      lastLogin: "2025-04-29T17:30:00",
      status: "active",
    },
  ];
};
...
const AdminReportCard = () => {
  ...
  useEffect(() => {
    const fetchReportData = async () => {
      const response = {
        ...
        monthlyGrowth: [
          120, 190, 130, 170, 150, 200, 220, 240, 210, 230, 250, 300,
        ],
      };
      setStats(response);
    };
    ...
    setTimeout(() => {
      ...
      switch (type) {
        case "user":
          ...
          fileName = `user_data_${new Date().toISOString().slice(0, 10)}.xls`;
          break;
        case "course":
          content =
            "course_id,title,enrollments,completion_rate\n101,Introduction to React,150,72%\n102,Advanced JavaScript,85,68%";
          mimeType = "application/vnd.ms-excel";
        ...
        case "all":
          ...
          mimeType = "application/vnd.ms-excel";
          fileName = `full_export_${new Date().toISOString().slice(0, 10)}.xls`;
          break;
        default:
          return;
      }
  ...
  const handleUserAddition = () => setShowModal(true);

  const handleInviteSubmit = ({ name, email, role }) => {
    /* create a throw-away password or use a backend token-flow */
    role = role.toLowerCase();
    email = email.toLowerCase();
    
    const password = Math.random().toString(36).slice(-8);

    /* 1️⃣  save to AuthContext (localStorage) */
    register({ email, password, firstName: name, lastName: "", role });

    console.log("User registration data: ", email, password, name, role);

    /* 2️⃣  show instantly in Users table */
    setUsers((prev) => [
      ...prev,
      {
        id: prev.length + 1,
    ...
    /* 3️⃣  TODO: call backend to actually email the credentials */
    // await fetch("/api/send-invite", { method:"POST", body: JSON.stringify({email, password}) });
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-800 mt-1">
                      {stats.totalLearners > 0
                        ? Math.round(
                            (stats.learnersCompleted / stats.totalLearners) *
                              100
                          )
                        : 0}
                      %
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="border border-gray-100 rounded-lg p-5 hover:shadow-md transition-shadow">
                ...
                <div className="mt-3 text-right text-xs text-gray-500">
                  Peak activity:{" "}
                  {timePeriod === "last7" ? "10 AM - 12 PM" : "2 PM - 4 PM"}
                </div>
              </div>
              ...
              <div className="border border-gray-100 rounded-lg p-5 lg:col-span-2 hover:shadow-md transition-shadow">
                ...
                <div className="mt-4 text-sm text-gray-500 border-t border-gray-100 pt-4">
                  <p>
                    Exports may take several minutes to prepare. You'll receive
                    an email when your download is ready.
                  </p>
                </div>
              </div>
            </div>

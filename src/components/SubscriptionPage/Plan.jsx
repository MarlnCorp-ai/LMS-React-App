...
function Plan({
  ...
  return (
    <Card key={key} className={`flex flex-col w-[22rem] h-[40rem]`}>
      <main className="w-full h-1/2 bg-white flex flex-col gap-4 p-6">
        ...
        <main className="w-full flex flex-col gap-4">
          ...
          <Link to={`/buy?currency=${symbol}&amount=${price}&role=business`}>
            <button className="text-white bg-purple-400/60 rounded-full w-full h-11 font-light text-sm">
              Buy Now
            </button>
          </Link>
